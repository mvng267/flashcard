...
const ReportsOverview: React.FC = () => {
  ...
  return (
    <div className="app-page">
      <header>
        <h1 className="app-title">Tổng quan hiệu suất</h1>
        <p className="app-subtitle">Báo cáo chi tiết hiệu suất flashcard trong 30 ngày qua.</p>
      </header>
      ...
      <section className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <Metric title="Phiên học" value={`${overview.study_sessions}`} icon={<BookOpen size={16} />} tone="sky" />
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <article className="lg:col-span-2 app-card p-6">
            ...
            {detailed.deck_breakdown.map((d) => (
              <div key={d.deck_id} className="group rounded-xl border border-slate-800/50 bg-slate-950/40 p-4 transition hover:border-slate-700">
                ...
                <div className="grid grid-cols-4 gap-2 text-[11px] text-slate-500">
                  ...
                  <div>Học: <b>{d.study_sessions}</b></div>
